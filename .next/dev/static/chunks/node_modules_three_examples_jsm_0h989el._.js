                ...
                for(const attributeName in attributes){
                    if (attributeName === '_COLOR_0') {
                        ...
                        if (instanceGeometry === null) {
                            ...
                            instanceGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferGeometry"]();
                        ...
                        const attr = attributes[attributeName];
                        instanceGeometry.setAttribute(attributeName, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstancedBufferAttribute"](attr.array, attr.itemSize, attr.normalized));
                    }
                }
                // Just in case
        ...
        for(let i = 0, il = primitives.length; i < il; i++){
            ...
            if (cached) {
                ...
                if (primitive.mode === WEBGL_CONSTANTS.TRIANGLE_STRIP) {
                    geometryPromise = geometryPromise.then((geometry)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$utils$2f$BufferGeometryUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTrianglesDrawMode"])(geometry, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TriangleStripDrawMode"]));
                } else if (primitive.mode === WEBGL_CONSTANTS.TRIANGLE_FAN) {
                    geometryPromise = geometryPromise.then((geometry)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$utils$2f$BufferGeometryUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTrianglesDrawMode"])(geometry, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TriangleFanDrawMode"]));
                }
                // Cache this geometry
                cache[cacheKey] = {
                    primitive: primitive,
        ...
        return Promise.all(pending).then(async function(results) {
            ...
            for(let i = 0, il = geometries.length; i < il; i++){
                ...
                if (primitive.mode === WEBGL_CONSTANTS.TRIANGLES || primitive.mode === WEBGL_CONSTANTS.TRIANGLE_STRIP || primitive.mode === WEBGL_CONSTANTS.TRIANGLE_FAN || primitive.mode === undefined) {
                    ...
                    mesh = needsSkinning && hasSkinningAttributes ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SkinnedMesh"](geometry, material) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
...
//# sourceMappingURL=node_modules_three_examples_jsm_0h989el._.js.map