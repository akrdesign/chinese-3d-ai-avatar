...
/*! Axios v1.20.0 Copyright (c) 2026 Matt Zabriskie and contributors */ var FormData$1 = __turbopack_context__.r("[project]/node_modules/form-data/lib/form_data.js [app-route] (ecmascript)");
...
const normalizeLookup = (lookup)=>{
    ...
    const callbackLookup = callbackify(lookup, (value)=>utils$1.isArray(value) ? value : [
            value
        ]);
    ...
    normalized = (hostname, opt, cb)=>{
        callbackLookup(hostname, opt, (err, arg0, arg1)=>{
            ...
            let addresses;
            try {
                addresses = utils$1.isArray(arg0) ? arg0.map((addr)=>buildAddressEntry(addr)) : [
...
//# sourceMappingURL=node_modules_axios_dist_node_axios_cjs_115~bkh._.js.map